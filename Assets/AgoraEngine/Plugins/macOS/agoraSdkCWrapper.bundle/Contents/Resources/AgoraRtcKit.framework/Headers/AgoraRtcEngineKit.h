...
/** Stops the local video preview and the video.
 ...
 @note Call this method after you start the local video preview and before you join the channel.
 ...
 **Note**:
 ...
 - This function requires a high-performance device. Agora recommends that
 you use this function on the following devices:
...
and receiving the [localAudioMixingStateDidChanged]([AgoraRtcEngineDelegate rtcEngine:localAudioMixingStateDidChanged:reason:])(`AgoraAudioMixingStatePlaying`) callback.
 ...
 @return * The audio mixing volume for publishing, if this method call is successful. The value ranges between 0 to 100.
* < 0: Failure.
*/
...
and receiving the [localAudioMixingStateDidChanged]([AgoraRtcEngineDelegate rtcEngine:localAudioMixingStateDidChanged:reason:])(`AgoraAudioMixingStatePlaying`) callback.
 ...
 @return * The audio mixing volume for local playback, if this method call is successful. The value ranges between 0 to 100.
* < 0: Failure.
*/
...
/** Enables the camera auto-face focus function. (iOS only.)
 ...
 @param enable * YES: (Default) Enable the camera auto-face focus function.
 * NO: Disable the camera auto-face focus function.
